...
function elevated_lite_menu() {
	add_theme_page( esc_html__( 'Elevated Theme Info', 'elevated-lite' ), esc_html__( 'Elevated Theme Info', 'elevated-lite' ), 'edit_theme_options', 'elevated-lite-theme', 'elevated_lite_theme_page_display' );
}
