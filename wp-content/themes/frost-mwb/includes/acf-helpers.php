...
/**
 * ACF JSON files are saved to /assets/
 */
function mwb_acf_json_save_point( $path ) {
	return get_stylesheet_directory() . '/assets/acf-json';
}
add_filter( 'acf/settings/save_json', 'mwb_acf_json_save_point' );
...
/**
 * Generate an href link HTML from an ACF link field object.
 *
...
/**
 * TODO
 * - Register blocks by scanning a directory?
 * - ACF Supports Align/Anchor?
 */
